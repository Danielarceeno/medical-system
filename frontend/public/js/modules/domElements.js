...
export const resultadosContainer = document.getElementById(
  "resultados-container"
);
export const paginationContainer = document.getElementById(
  "pagination-container"
);
export const comparacaoContainer = document.getElementById(
...
export const modalBotaoSubmit = document.querySelector(
  "#modal-cadastro .botao-form-submit"
);
